...
BROADCAST_TM_BIN="fun2_broadcast_tm"
DEFAULT_UNLI_BIN="fun2_default_unli"
MLP_BIN="fun2_mlp"
SHAMPOO_BIN="fun2_shampoo"
APP_BIN_LIST="$REQUEST_BIN $RESPONSE_BIN $TRANSACTION_BIN $TRANSACTION_TM_BIN $BROADCAST_BIN $BROADCAST_TM_BIN $DEFAULT_UNLI_BIN $MLP_BIN $SHAMPOO_BIN"
