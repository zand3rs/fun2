	...
	else
	{
		...
		if(isset($_POST))
		{
			...
			if(null != $allfields)
			{
			   ...
			   if($ret['error'])
			   {
				$gSmarty->assign('error_msg', "Update Service Failed.");
			   }
			   else
			   {
				...
				$gSmarty->assign('error_msg', "Update Service Successfully Completed.");
...
else
{
	...
	if($postf == null)
	{
	   $gSmarty->assign('error_msg', UPDATE_SERVICE_FAILED_NO_RECORD_FOUND); 
	}
...
$gSmarty->assign('form_action',   "update_service.php");
