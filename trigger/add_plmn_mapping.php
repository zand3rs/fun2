	...
	else
	{
		...
		if(isset($_POST))
		{
			if(null != $allfields)
			{
			   ...
			   if($ret['error'])
			   {
				$gSmarty->assign('error_msg', "Add PLMN Mapping Failed.");
			   }
			   else
			   {
				//lookup
				...
				$gSmarty->assign('error_msg', "Add PLMN Mapping Successfully Completed.");
...
$gSmarty->assign('form_action',   'add_plmn_mapping.php');
