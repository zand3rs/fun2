	...
	else
	{
		...
		if(isset($_POST))
		{
			...
			if(null != $allfields)
			{
			   ...
			   if($ret['error'])
			   {
				$gSmarty->assign('error_msg', "Update SSET Mapping Failed.");
			   }
			   else
			   {
				//lookup
				...
				$gSmarty->assign('error_msg', "Update SSET Mapping Successfully Completed.");
...
else
{
	...
	if($postf == null)
	{
	   $gSmarty->assign('error_msg', UPDATE_SSET_MAPPING_FAILED_NO_RECORD_FOUND); 
	}
...
$gSmarty->assign('form_action',   "update_sset_mapping.php");
