	...
	else
	{
		...
		if(isset($_POST))
		{
			if(null != $allfields)
			{
			   ...
			   if($ret['error'])
			   {
				$gSmarty->assign('error_msg', "Add IN Mapping Failed.");
			   }
			   else
			   {
				//lookup
				...
				$gSmarty->assign('error_msg', "Add IN Mapping Successfully Completed.");
...
$gSmarty->assign('form_action',   'add_insrvr_mapping.php');
