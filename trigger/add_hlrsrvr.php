	...
	else
	{
		...
		if(isset($_POST))
		{
			if(null != $allfields)
			{
			   ...
			   if($ret['error'])
			   {
				$gSmarty->assign('error_msg', "Add HLR Server Failed.");
			   }
			   else
			   {
				//lookup
				...
				$gSmarty->assign('error_msg', "Add HLR Server Successfully Completed.");
...
$gSmarty->assign('form_action',   'add_hlrsrvr.php');
