...
$href_desc      = $sorter_href."&sortedby=imsi&btnSubmit=Search";
...
$btnSubmit='Search';
if ($btnSubmit=='Search') {
	if((strlen($_GET['scode']) > 0) && (!@preg_match("/^515[0-9]{0,7}$/i", $_GET['scode'])) )
		$gSmarty->assign('error_msg', "ERROR: Invalid IMSI.");
	else
