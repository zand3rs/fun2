	...
	else
	{
		...
		if(isset($_POST))
		{
			...
			if(null != $allfields)
			{
			   ...
			   if($ret['error'])
			   {
				$gSmarty->assign('error_msg', "Update Keyword Failed.");
			   }
			   else
			   {
				...
				$gSmarty->assign('error_msg', "Update Keyword Successfully Completed.");
...
else
{
	...
	if($postf == null)
	{
	   $gSmarty->assign('error_msg', UPDATE_KEYWORD_FAILED_NO_RECORD_FOUND); 
	}
...
$gSmarty->assign('form_action',   "update_keyword.php");
