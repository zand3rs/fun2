...
else
{
	//get list
        if ($btnSubmit == 'Search')
		$listdata  = $master->ListSubscribers($extravars, $q_sdate, $q_edate, $q_tran_id, $q_status, $q_msisdn, $q_service);
...
$soptstat   = $soption->getSubsStatusSearch2();
...
//show-it
$gSmarty->display('list_trigger_subs.tpl');
