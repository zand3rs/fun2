...
{include file="header.tpl"}
    ...
    <!-- form -->
    <form name="mainform" method="post" action="list_gcash_log_master.php">

    
	   <!--Pagetitle -->
	   <div id="title">GCASH Log List</div>
           <div id="desc">
	    ...
	    {/if}
		  ...
		  <tr>	
			...
			<td width="200" class="label">Packet</td>
		   ...
		   <td class="child" width="200">&nbsp;{$ldata.gcash_packet}</td>
