...
$href_ref       = $sorter_href."&sortedby=ref";

$gSmarty->assign('href_sort_appref_id'  , $href_ref);
...
//get list
$listdata  = $umaster->getListTranReqLog($extravars);
...
//show-it
$gSmarty->display('list_tran_req_log_master.tpl');
?>
