<?php /* Smarty version 2.6.20, created on 2010-05-11 05:45:55
         compiled from bulk_blacklisting.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'bulk_blacklisting.tpl', 60, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ?>
	...
	<form action="bulk_blacklisting.php" enctype="multipart/form-data" method="post">

	   <!--Pagetitle -->
	   <div id="title">Bulk Blacklisting</div>
           <div id="desc">
