<?php /* Smarty version 2.6.20, created on 2010-05-09 23:59:11
         compiled from list_blackwhite.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'list_blackwhite.tpl', 25, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <!-- form -->
    <form name="mainform" method="post" action="list_blackwhite.php">

    
	<!--Pagetitle -->
	<div id="title">Blacklist/Whitelist History</div>
...
"/></td>
	...
	<?php if ($this->_tpl_vars['is_searched'] == '1'): ?>
		...
		<table border="0" cellspacing="0" cellpadding="0" id="tablestyle" width="100%">
			...
			<td width="100" class="label">Type</td>
...
?>
				...
				<td class="child" width="100">&nbsp;<?php echo $this->_tpl_vars['ldata']['action']; ?>
</td>
