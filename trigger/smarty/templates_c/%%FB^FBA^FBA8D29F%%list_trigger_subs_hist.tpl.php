<?php /* Smarty version 2.6.20, created on 2010-04-08 11:39:12
         compiled from list_trigger_subs_hist.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'list_trigger_subs_hist.tpl', 25, false),array('function', 'html_options', 'list_trigger_subs_hist.tpl', 46, false),)), $this); ?>
...
"/></td>
		...
		<td colspan="3" class="child"><input type="text" name="q_msisdn" maxlength="20" value="<?php echo $this->_tpl_vars['q_msisdn']; ?>
"/></td>
<!--
...
?>
				<tr >
		                <td class="child" width="100"><a href="details_trigger_subs_hist.php?uid=<?php echo get_uid(); ?>&tran_id=<?php echo $this->_tpl_vars['ldata']['tran_id']; ?>
" title="View Subscriber History Info" rel="gb_page_center[<?php echo $this->_tpl_vars['popup_win_width']; ?>
, <?php echo $this->_tpl_vars['popup_win_height']; ?>
				...
				<!-- td class="child" width="80" >&nbsp;<?php echo $this->_tpl_vars['ldata']['msisdn']; ?>
</td -->
				...
				<td class="child" width="50" >&nbsp;<?php echo $this->_tpl_vars['ldata']['reactivation_dt']; ?>
</td>
				...
				<td class="child" width="100">&nbsp;<?php echo $this->_tpl_vars['ldata']['remarks']; ?>
</td>
				</tr>
