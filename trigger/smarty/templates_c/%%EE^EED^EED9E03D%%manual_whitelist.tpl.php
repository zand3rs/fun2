<?php /* Smarty version 2.6.20, created on 2010-01-29 13:14:09
         compiled from manual_whitelist.tpl */ ?>
...
unset($_smarty_tpl_vars);
 ?>
	...
	<div id="title">Manual Whitelisting</div>
		<?php if (( $this->_tpl_vars['is_searched'] == '1' ) && ( $this->_tpl_vars['error_msg'] == 'SAVING_WHITELIST_SUCCESS' )): ?>
			<div id="errorbox">
			<br/>
