<?php /* Smarty version 2.6.20, created on 2010-05-26 18:27:16
         compiled from list_hlrsrvr_mapping.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'list_hlrsrvr_mapping.tpl', 23, false),array('function', 'html_options', 'list_hlrsrvr_mapping.tpl', 34, false),)), $this); ?>
...
?>
		   ...
		   <td class="child" width="200">
			<a href="update_hlrsrvr_mapping.php?uid=<?php echo get_uid(); ?>&id=<?php echo $this->_tpl_vars['ldata']['id']; ?>
"><img src="images/update.jpg"  border="0"></a>
			&nbsp;
			<a href="delete_hlrsrvr_mapping.php?uid=<?php echo get_uid(); ?>&id=<?php echo $this->_tpl_vars['ldata']['id']; ?>
		...
		<?php endif; ?>
    		 ...
    		 <!--buttons-->
		      <div id="buttonh">
			   ...
			   <a href="add_hlrsrvr_mapping.php?uid=<?php echo get_uid(); ?>"><img src="images/add.jpg"  border="0"></a>
			   </td>
		          </tr>
		        </table>
		      </div>
