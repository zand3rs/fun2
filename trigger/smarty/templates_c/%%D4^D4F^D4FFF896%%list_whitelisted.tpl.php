<?php /* Smarty version 2.6.20, created on 2010-02-08 10:13:52
         compiled from list_whitelisted.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'list_whitelisted.tpl', 25, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <!-- form -->
    <form name="mainform" method="post" action="list_whitelisted.php">

    
	<!--Pagetitle -->
	<div id="title">Whitelisted Subscribers</div>
