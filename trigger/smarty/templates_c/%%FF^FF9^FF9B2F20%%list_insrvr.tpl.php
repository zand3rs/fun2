<?php /* Smarty version 2.6.20, created on 2010-12-08 14:47:05
         compiled from list_insrvr.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'list_insrvr.tpl', 23, false),array('function', 'html_options', 'list_insrvr.tpl', 40, false),)), $this); ?>
 ...
 Result(s) found.&nbsp;
	   ...
	   <?php endif; ?>
	         ...
	         <div id="wrapper">
				...
				<td width="150" class="child"><input type="text" name="scode" maxlength="30" style="width:200px" value="<?php echo $this->_tpl_vars['q_scode']; ?>
"/></td>
...
?>
		   ...
		   <td class="child" width="50" >&nbsp;<?php echo $this->_tpl_vars['ldata']['svc_name']; ?>
    </td>
		   ...
		   <td class="child" width="50" >&nbsp;<?php echo $this->_tpl_vars['ldata']['expiry']; ?>
      </td>
		   <td class="child" width="100">&nbsp;<?php echo $this->_tpl_vars['ldata']['status']; ?>
      </td>
		   <td class="child" width="200">
			<a href="update_insrvr.php?uid=<?php echo get_uid(); ?>&id=<?php echo $this->_tpl_vars['ldata']['id']; ?>
"><img src="images/update.jpg"  border="0"></a>
			&nbsp;
			<a href="delete_insrvr.php?uid=<?php echo get_uid(); ?>&id=<?php echo $this->_tpl_vars['ldata']['id']; ?>
		...
		<?php endif; ?>
    		 ...
    		 <!--buttons-->
		      <div id="buttonh">
			   ...
			   <a href="add_insrvr.php?uid=<?php echo get_uid(); ?>"><img src="images/add.jpg"  border="0"></a>
			   </td>
		          </tr>
		        </table>
		      </div>
