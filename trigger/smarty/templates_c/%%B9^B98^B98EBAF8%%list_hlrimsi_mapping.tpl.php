<?php /* Smarty version 2.6.20, created on 2011-09-27 07:52:19
         compiled from list_hlrimsi_mapping.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'list_hlrimsi_mapping.tpl', 23, false),array('function', 'html_options', 'list_hlrimsi_mapping.tpl', 34, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <!-- form -->
    <form name="mainform" method="get" action="list_hlrimsi_mapping.php">

    
	   <!--Pagetitle -->
	   <div id="title">HLR Server IMSI Mapping List</div>
	         ...
	         <div id="wrapper">
				...
				<td width="150" class="label">Server Name</td>
					...
					<select name="sname_l" id="sname_l">
						<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['sopthlrsvr'],'selected' => $this->_tpl_vars['q_sname_l']), $this);?>

					</select>  
				</td>
				<td width="150" class="label">IMSI <br>(Ex. 515xxxx)</td>
				<td width="150" class="child"><input type="text" name="scode" maxlength="7" value="<?php echo $this->_tpl_vars['q_scode']; ?>
"/></td>
				</tr>
				<tr>
...
?>
		   ...
		   <td class="child" width="80" >&nbsp;<?php echo $this->_tpl_vars['ldata']['server_ip']; ?>
   </td>
		   <td class="child" width="80" >&nbsp;<?php echo $this->_tpl_vars['ldata']['imsi']; ?>
        </td>
		   <td class="child" width="100">&nbsp;<?php echo $this->_tpl_vars['ldata']['status']; ?>
      </td>
		   <td class="child" width="200">
			<a href="update_hlrimsi_mapping.php?uid=<?php echo get_uid(); ?>&id=<?php echo $this->_tpl_vars['ldata']['id']; ?>
"><img src="images/update.jpg"  border="0"></a>
			&nbsp;
			<a href="delete_hlrimsi_mapping.php?uid=<?php echo get_uid(); ?>&id=<?php echo $this->_tpl_vars['ldata']['id']; ?>
		...
		<?php endif; ?>
    		 ...
    		 <!--buttons-->
		      <div id="buttonh">
			   ...
			   <a href="add_hlrimsi_mapping.php?uid=<?php echo get_uid(); ?>"><img src="images/add.jpg"  border="0"></a>
			   </td>
		          </tr>
		        </table>
		      </div>
