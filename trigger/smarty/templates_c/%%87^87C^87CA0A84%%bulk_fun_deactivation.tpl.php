<?php /* Smarty version 2.6.20, created on 2010-11-27 14:00:14
         compiled from bulk_fun_deactivation.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'bulk_fun_deactivation.tpl', 62, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ?>
	...
	<form action="bulk_fun_deactivation.php" enctype="multipart/form-data" method="post">

	   <!--Pagetitle -->
	   <div id="title">Bulk Fun Deactivation</div>
           <div id="desc">
...
?>
           	<tr >
		   <td class="child" width="100"><?php echo $this->_tpl_vars['ldata']['ofw_sim']; ?>
</td>
		   <td class="child" width="100"><?php echo $this->_tpl_vars['ldata']['local_sim']; ?>
</td>
