<?php /* Smarty version 2.6.20, created on 2010-02-11 13:49:34
         compiled from bulk_deactivation.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'bulk_deactivation.tpl', 63, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ?>
	...
	<form action="bulk_deactivation.php" enctype="multipart/form-data" method="post">

	   <!--Pagetitle -->
	   <div id="title">Bulk Deactivation</div>
           <div id="desc">
 ...
 record(s) uploaded.&nbsp;
	    ...
	    <?php endif; ?>
		  ...
		  <tr>	
                ...
                <tr>
                <td colspan="3" class="child">Format: 639xxxxxxxxx,Name,ContactNo,Remarks</td>
                </tr>
		</table>
		</div>
	</form>
	...
	<?php if ($this->_tpl_vars['list_total'] >= 0): ?>
		  ...
		  <tr>	
           	   ...
           	   <td width="200" class="label">Name</td>
           	   <td width="100" class="label">Contact No</td>
...
?>
		   ...
		   <td class="child" width="200">&nbsp;<?php echo $this->_tpl_vars['ldata']['subs_name']; ?>
</td>
		   <td class="child" width="100">&nbsp;<?php echo $this->_tpl_vars['ldata']['subs_contact_no']; ?>
</td>
