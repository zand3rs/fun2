<?php /* Smarty version 2.6.20, created on 2010-12-08 14:05:22
         compiled from bulk_activation.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'bulk_activation.tpl', 64, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ?>
	...
	<form action="bulk_activation.php" enctype="multipart/form-data" method="post">

	   <!--Pagetitle -->
	   <div id="title">Bulk Activation</div>
           <div id="desc">
