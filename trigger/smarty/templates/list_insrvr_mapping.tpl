	         ...
	         <div id="wrapper">
				...
				<td width="150" class="label">Server Name</td>
					...
					<select name="sname_l" id="sname_l">
						{html_options options=$soptinsvr selected=$q_sname_l}
					</select>  
				</td>
		...
		{else}
		  <tr>	
		   ...
		   <td class="child" width="200">
			<a href="update_insrvr_mapping.php?uid={php}echo get_uid();{/php}&id={$ldata.id}"><img src="images/update.jpg"  border="0"></a>
			&nbsp;
			<a href="delete_insrvr_mapping.php?uid={php}echo get_uid();{/php}&id={$ldata.id}"><img src="images/delete.jpg"  border="0"></a>
		   </td>
	   	</tr>
           	{/foreach}
           	<tr>
		...
		{/if}
    		 ...
    		 <!--buttons-->
		      <div id="buttonh">
			   ...
			   <a href="add_insrvr_mapping.php?uid={php}echo get_uid();{/php}"><img src="images/add.jpg"  border="0"></a>
			   </td>
		          </tr>
		        </table>
		      </div>
