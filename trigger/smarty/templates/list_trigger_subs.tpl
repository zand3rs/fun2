...
{include file="menu.tpl"}
	...
	<table border="0" cellspacing="0" cellpadding="0" id="tablestyle">
		...
		<td width="150" class="child"><input type="text" name="q_msisdn" maxlength="20" value="{$q_msisdn}"/></td>
	...
	<div id="wrapper">
		...
		<table border="0" cellspacing="0" cellpadding="0" id="tablestyle" width="100%">
			...
			<td width="50"  class="label">Source</td>
				...
				<tr >
		                <td class="child" width="100"><a href="details_trigger_subs.php?uid={php}echo get_uid();{/php}&tran_id={$ldata.tran_id}" title="View Subscriber Info" rel="gb_page_center[{$popup_win_width}, {$popup_win_height}]">{$ldata.msisdn}</a></td>
