    ...
    <form name="mainform" method="get" action="list_hlrimsi_mapping.php">
	   ...
	   {/if}
	         ...
	         <div id="wrapper">
				...
				<td width="150" class="child"><input type="text" name="scode" maxlength="7" value="{$q_scode}"/></td>
				</tr>
				<tr>
	...
	{if $is_searched=="1"}
		...
		{else}
		  <tr>	
           	   ...
           	   <td width="80"  class="label"><a class="hhref" href="{$href_sort_code}&scode={$q_scode}&sname={$q_sname}&sstat={$q_sstat}&wsort={$q_ssort}">Server IP</a></td>
           	   <td width="80"  class="label"><a class="hhref" href="{$href_sort_desc}&scode={$q_scode}&sname={$q_sname}&sstat={$q_sstat}&wsort={$q_ssort}">IMSI</td>
		   ...
		   <td class="child" width="80" >&nbsp;{$ldata.server_ip}   </td>
		   <td class="child" width="80" >&nbsp;{$ldata.imsi}        </td>
		   <td class="child" width="100">&nbsp;{$ldata.status}      </td>
		   <td class="child" width="200">
			<a href="update_hlrimsi_mapping.php?uid={php}echo get_uid();{/php}&id={$ldata.id}"><img src="images/update.jpg"  border="0"></a>
			&nbsp;
			<a href="delete_hlrimsi_mapping.php?uid={php}echo get_uid();{/php}&id={$ldata.id}"><img src="images/delete.jpg"  border="0"></a>
		   </td>
	   	</tr>
           	{/foreach}
           	<tr>
		...
		{/if}
    		 ...
    		 <!--buttons-->
		      <div id="buttonh">
			   ...
			   <a href="add_hlrimsi_mapping.php?uid={php}echo get_uid();{/php}"><img src="images/add.jpg"  border="0"></a>
			   </td>
		          </tr>
		        </table>
		      </div>
