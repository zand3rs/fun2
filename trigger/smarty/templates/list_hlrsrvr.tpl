	   ...
	   <div id="title">HLR Server List</div>
	    ...
	    {/if}
	         ...
	         <div id="wrapper">
				...
				<td width="150" class="child"><input type="text" name="scode" maxlength="30" value="{$q_scode}"/></td>
		...
		{else}
		  <tr>	
		   ...
		   <td class="child" width="200">
			<a href="update_hlrsrvr.php?uid={php}echo get_uid();{/php}&id={$ldata.id}"><img src="images/update.jpg"  border="0"></a>
			&nbsp;
			<a href="delete_hlrsrvr.php?uid={php}echo get_uid();{/php}&id={$ldata.id}"><img src="images/delete.jpg"  border="0"></a>
		   </td>
	   	</tr>
           	{/foreach}
           	<tr>
		...
		{/if}
    		 ...
    		 <!--buttons-->
		      <div id="buttonh">
			   ...
			   <a href="add_hlrsrvr.php?uid={php}echo get_uid();{/php}"><img src="images/add.jpg"  border="0"></a>
			   </td>
		          </tr>
		        </table>
		      </div>
