...
if($_GET['uid'] and $_GET['id']>0)
{
	...
	if($ret['error'])
	{
                        ...
                        if ($ukerr == 1)
				$gSmarty->assign('error_msg', "Delete HLR Server Failed - Integrity Constraint Violated.");
                        else
				$gSmarty->assign('error_msg', "Delete HLR Server Failed.");
	}
	else
	{
		//lookup
		...
		$gSmarty->assign('error_msg', "Delete HLR Server Successfully Completed.");
