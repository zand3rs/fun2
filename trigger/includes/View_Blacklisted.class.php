...
/**
#----------------------------------------------------------------------------------
#	@Filename	:	View_Blacklisted.class.php
...
//class
class View_Blacklisted
{

	var $_Data;

	//constructor
	function View_Blacklisted()
	{
		//reset
		$this->_Data = null;
	}
	...
	function ListSubscribers($extravars, $q_sdate,$q_edate,$q_msisdn )
	{
		...
		$sql  = " SELECT COUNT(1) AS COUNT FROM BLACKLISTED_LOG a $mwhere ";
		...
		$mselect = "  SELECT msisdn,to_char(dt_created,'YYYY-MM-DD HH24:MI:SS') dt_created,".
		           "        created_by, remarks ".
		           "  FROM BLACKLISTED_LOG  a $mwhere $orderby ";
