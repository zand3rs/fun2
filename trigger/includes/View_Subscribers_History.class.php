...
/**
#----------------------------------------------------------------------------------
#	@Filename	:	View_Subscribers_History.class.php	
#	@Description	:	encapsulator for table Sim_Activation_History
#
#
#	@Date		: 2009-04-30
#	@Ver		:	ver1.1
...
define('CSV_HEADER_SUBS_REPORT',  "msisdn, country, activation_dt, deactivation_dt, reactivation_dt, extended, last_daily_bal, country_name, min_bal, breathing_period, source, subscriber_name, name_of_req_party, remarks");

//class
class View_Subscribers_History
{

	var $_Data;

	//constructor
	function View_Subscribers_History()
	{
		//reset
		$this->_Data = null;
	}
	...
	function ListSubscribers($extravars, $q_sdate,$q_edate,$q_tran_id, $q_status,$q_msisdn,$q_service)
	{
		...
		$sql  = " SELECT COUNT(1) AS COUNT FROM SIM_ACTIVATION_HISTORY a $mwhere ";
		...
		//orderby
		$orderby = " ORDER BY a.deactivation_tm desc, a.activation_tm desc ";
		...
		$mselect = "  SELECT id tran_id, msisdn, country_name country, subscriber_name, name_of_req_party, status, ".
                           "         to_char(activation_tm,'YYYY-MM-DD HH24:MI:SS') activation_dt, to_char(deactivation_tm,'YYYY-MM-DD HH24:MI:SS') deactivation_dt, ".
		           "         request_origin act_deact_src, daily_bal, decode(nvl(extended,0),0,'No', 'Yes') extended, duration, ".
                           ...
                           "         to_char(reactivation_dt,'YYYY-MM-DD') reactivation_dt, remarks ".
		           "  FROM SIM_ACTIVATION_HISTORY a $mwhere $orderby ";
	...
	function GetSubscriber($id='')
	{
		...
		$mselect = "  SELECT id tran_id, msisdn, country_name country, subscriber_name, name_of_req_party, status, ".
		           ...
		           "         request_origin act_deact_src, decode(nvl(extended,0),0,'No', 'Yes') extended, duration, ".
                           ...
                           "         to_char(last_country_chk, 'YYYY-MM-DD') last_country_chk, hot_country_cnt, remarks, customer_type ".
		           "  FROM SIM_ACTIVATION_HISTORY a $mwhere ";
		$sql     = "  $mselect ";
