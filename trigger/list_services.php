...
$href_priority  = $sorter_href."&sortedby=priority&btnSubmit=Search";
$href_status    = $sorter_href."&sortedby=statu&btnSubmit=Search";

$gSmarty->assign('href_sort_name'        , $href_name);
$gSmarty->assign('href_sort_desc'        , $href_desc);
$gSmarty->assign('href_sort_priority'    , $href_priority);
